    ...
    return (
        <>
            <nav className="flex flex-row justify-between items-center px-2 md:px-10 h-24 fixed top-0 left-0 right-0 z-40 bg-[#e2c3c8] bg-opacity-70 backdrop-blur-sm">
                ...
                {router.pathname !== '/users' && <Link href='/users'><p className="font-caveat text-4xl cursor-pointer">Manage Users</p></Link>}
                {router.pathname !== '/' && <Link href='/'><p className="font-caveat text-4xl cursor-pointer">Manage Products</p></Link>}
